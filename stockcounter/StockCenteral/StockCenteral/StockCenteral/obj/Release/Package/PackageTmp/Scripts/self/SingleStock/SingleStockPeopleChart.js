$(function () {
    ...
    $('#SingleStockPeopleChartTDDC').highcharts({
        //options: MySkin,
        chart: {
        ...
        series: [
            ...
            { name: '1-999(股)', data: [0], visible: false },
            { name: '1-5(張)', data: [0], visible: false },
            { name: '5-10(張)', data: [0], visible: false },
            { name: '10-15(張)', data: [0], visible: false },
            { name: '15-20(張)', data: [0], visible: false },
            { name: '20-30(張)', data: [0], visible: false },
            { name: '30-40(張)', data: [0], visible: false },
            { name: '40-50(張)', data: [0], visible: false },
            { name: '50-100(張)', data: [0], visible: false },
            { name: '100-200(張)', data: [0], visible: false },
            { name: '200-400(張)', data: [0], visible: false },
            { name: '400-600(張)', data: [0], visible: false },
            { name: '600-800(張)', data: [0], visible: false },
            { name: '800-1000(張)', data: [0], visible: false },
            { name: '1000以上(張)', data: [0] }]
    });
 
});

function SetSingleStockPeopleChart(Param) {
    ...
    $.ajax({
        type: 'POST',
        url: root + "/api/SingleStockApi/GetSingleStockPeopleChart",
        data: Param,  //------------------------參數丟入
        success: function (data) {

            var TargetChart = $('#SingleStockPeopleChartTDDC').highcharts();
