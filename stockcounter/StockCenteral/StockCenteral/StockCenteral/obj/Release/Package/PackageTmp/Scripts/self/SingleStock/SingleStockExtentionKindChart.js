$(function () {
    ...
    $('#SingleStockExtentionKindChartTDDC').highcharts({
        ...
        series: [{ name: '自訂1', data: [0.00], visible: true },
            { name: '自訂2', data: [0.00], visible: true },
            { name: '自訂3', data: [0.00], visible: true },
            { name: '自訂4', data: [0.00], visible: true },
            { name: '自訂5', data: [0.00], visible: true }
        ]
    });
 
});

function SetSingleStockExtentionKindChartTDDC(Param) {
    ...
    $.ajax({
        ...
        success: function (data) {
            //指定hightChart
            var TargetChart = $('#SingleStockExtentionKindChartTDDC').highcharts();
            //放進日期
